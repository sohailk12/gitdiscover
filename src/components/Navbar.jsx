...
const pages = ['Repositories', 'Users', 'Search'];
  ...
  return (
    ...
    <AppBar position="fixed" sx={{backgroundColor:'#0f0f0f'}}>
      <Container maxWidth="xl">
        <Toolbar disableGutters sx={{display:'flex',alignContent:'justify-between'}}>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' },border:'1px solid black',alignItems:'flex-end',justifyContent:'flex-end' }}>
            {pages.map((page) => (
              <Button
                key={page}
